            ...
            <div class="py-4 border-bottom">
                <div class="d-flex">
                    <div class="flex-shrink-0 align-self-center me-3">
                        <img src="{{ URL::asset('images/users/avatar-1.jpg') }}" class="avatar-xs rounded-circle" alt="">
                    </div>
                                ...
                                <li class="active">
                                    <a href="javascript: void(0);">
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-shrink-0 align-self-center me-3">
                                                <img src="{{ URL::asset('images/users/avatar-2.jpg') }}" class="rounded-circle avatar-xs" alt="">
                                            </div>
                                ...
                                <li>
                                    <a href="javascript: void(0);">
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-shrink-0 align-self-center me-3">
                                                <img src="{{ URL::asset('images/users/avatar-3.jpg') }}" class="rounded-circle avatar-xs" alt="">
                                            </div>
                                ...
                                <li>
                                    <a href="javascript: void(0);">
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-shrink-0 align-self-center me-3">
                                                <img src="{{ URL::asset('images/users/avatar-4.jpg') }}" class="rounded-circle avatar-xs" alt="">
                                            </div>
                                            <div class="flex-grow-1 overflow-hidden">
                                ...
                                <li>
                                    <a href="javascript: void(0);">
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-shrink-0 align-self-center me-3">
                                                <img src="{{ URL::asset('images/users/avatar-6.jpg') }}" class="rounded-circle avatar-xs" alt="">
                                            </div>
                                            <div class="flex-grow-1 overflow-hidden">
