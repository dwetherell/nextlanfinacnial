                                    ...
                                    <ul class="list-inine ps-0 mb-4">
                                            ...
                                            <a href="#">
                                                <div class="border rounded avatar-sm">
                                                    <span class="avatar-title bg-transparent">
                                                        <img src="{{ URL::asset('images/companies/img-1.png') }}"
                                                            alt="" class="avatar-xs">
                                                    </span>
                                                </div>
                                            </a>
                                        ...
                                        <li class="list-inline-item">
                                            <a href="#">
                                                <div class="border rounded avatar-sm">
                                                    <span class="avatar-title bg-transparent">
                                                        <img src="{{ URL::asset('images/companies/img-2.png') }}"
                                                            alt="" class="avatar-xs">
                                                    </span>
                                                </div>
                                            </a>
                                        ...
                                        <li class="list-inline-item">
                                            <a href="#">
                                                <div class="border rounded avatar-sm">
                                                    <span class="avatar-title bg-transparent">
                                                        <img src="{{ URL::asset('images/companies/img-3.png') }}"
                                                            alt="" class="avatar-xs">
                                                    </span>
                                                </div>
                                            </a>
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="list-inline mb-4">
                                        <li class="list-inline-item">
                                            <a href="#">
                                                <div>
                                                    <img src="{{ URL::asset('images/small/img-4.jpg') }}"
                                        ...
                                        <li class="list-inline-item">
                                            <a href="#">
                                                <div>
                                                    <img src="{{ URL::asset('images/small/img-5.jpg') }}"
                                                        class="rounded" alt="" height="48">
                                                </div>
                                            </a>
                                        </li>
                                        <li class="list-inline-item">
                                            <a href="#">
                                                <div>
                                                    <img src="{{ URL::asset('images/small/img-6.jpg') }}"
                                                        class="rounded" alt="" height="48">
                                                </div>
                                            </a>
                                        </li>
