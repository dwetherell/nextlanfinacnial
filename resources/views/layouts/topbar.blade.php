    ...
    <div class="d-flex">
        ...
        <div class="dropdown d-inline-block">
            <button type="button" class="btn header-item waves-effect"
                ...
                @switch(Session::get('lang'))
                    @case('ru')
                        <img src="{{ URL::asset('images/flags/russia.jpg')}}" alt="Header Language" height="16">
                    @break
                    @case('it')
                        <img src="{{ URL::asset('images/flags/italy.jpg')}}" alt="Header Language" height="16">
                    @break
                    @case('gr')
                        <img src="{{ URL::asset('images/flags/germany.jpg')}}" alt="Header Language" height="16">
                    @break
                    @case('sp')
                        <img src="{{ URL::asset('images/flags/spain.jpg')}}" alt="Header Language" height="16">
                    @break
                    @default
                        <img src="{{ URL::asset('images/flags/us.jpg')}}" alt="Header Language" height="16">
                @endswitch
            </button>
        ...
        <div class="dropdown d-inline-block">
            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <img class="rounded-circle header-profile-user" src="{{ isset(Auth::user()->avatar) ? asset(Auth::user()->avatar) : asset('images/users/avatar-1.jpg') }}"
                    alt="Header Avatar">
