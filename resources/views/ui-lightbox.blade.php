        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="popup-gallery d-flex flex-wrap">
                    <a href="{{ URL::asset('images/small/img-1.jpg') }}" title="Project 1">
                        <div class="img-fluid">
                            <img src="{{ URL::asset('images/small/img-1.jpg') }}" alt="" width="120">
                        </div>
                    </a>
                    <a href="{{ URL::asset('images/small/img-2.jpg') }}" title="Project 2">
                        <div class="img-fluid">
                            <img src="{{ URL::asset('images/small/img-2.jpg') }}" alt="" width="120">
                        </div>
                    </a>
                    <a href="{{ URL::asset('images/small/img-3.jpg') }}" title="Project 3">
                        <div class="img-fluid">
                            <img src="{{ URL::asset('images/small/img-3.jpg') }}" alt="" width="120">
                        </div>
                    </a>
                    <a href="{{ URL::asset('images/small/img-4.jpg') }}" title="Project 4">
                        <div class="img-fluid">
                            <img src="{{ URL::asset('images/small/img-4.jpg') }}" alt="" width="120">
                        </div>
                    </a>
                    <a href="{{ URL::asset('images/small/img-5.jpg') }}" title="Project 5">
                        <div class="img-fluid">
                            <img src="{{ URL::asset('images/small/img-5.jpg') }}" alt="" width="120">
                        </div>
                    </a>
                    <a href="{{ URL::asset('images/small/img-6.jpg') }}" title="Project 6">
                        <div class="img-fluid">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="zoom-gallery d-flex flex-wrap">
                    <a href="{{ URL::asset('images/small/img-3.jpg') }}" title="Project 1"><img src="{{ URL::asset('images/small/img-3.jpg') }}" alt="" width="275"></a>
                    <a href="{{ URL::asset('images/small/img-7.jpg') }}" title="Project 2"><img src="{{ URL::asset('images/small/img-7.jpg') }}" alt="" width="275"></a>
                </div>
            </div>
        </div>
    </div>
