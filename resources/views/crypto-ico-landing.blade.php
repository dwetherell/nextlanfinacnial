                    ...
                    <div class="owl-carousel owl-theme clients-carousel" id="clients-carousel" dir="ltr">
                        <div class="item">
                            <div class="client-images">
                                <img src="{{ URL::asset('images/clients/1.png') }}" alt="client-img"
                                    class="mx-auto img-fluid d-block">
                            </div>
                        </div>
                        <div class="item">
                            <div class="client-images">
                                <img src="{{ URL::asset('images/clients/2.png') }}" alt="client-img"
                                    class="mx-auto img-fluid d-block">
                            </div>
                        </div>
                        <div class="item">
                            <div class="client-images">
                                <img src="{{ URL::asset('images/clients/3.png') }}" alt="client-img"
                                    class="mx-auto img-fluid d-block">
                            </div>
                        </div>
                        <div class="item">
                            <div class="client-images">
                                <img src="{{ URL::asset('images/clients/4.png') }}" alt="client-img"
                                    class="mx-auto img-fluid d-block">
                            </div>
                        </div>
                        <div class="item">
                            <div class="client-images">
                                <img src="{{ URL::asset('images/clients/5.png') }}" alt="client-img"
                                    class="mx-auto img-fluid d-block">
                            </div>
                        </div>
                        <div class="item">
                            <div class="client-images">
                                <img src="{{ URL::asset('images/clients/6.png') }}" alt="client-img"
                                    class="mx-auto img-fluid d-block">
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            ...
            <div class="row align-items-center pt-4">
                <div class="col-md-6 col-sm-8">
                    <div>
                        <img src="{{ URL::asset('images/crypto/features-img/img-1.png') }}" alt=""
            ...
            <div class="row align-items-center mt-5 pt-md-5">
                ...
                <div class="col-md-6  col-sm-8 ms-md-auto">
                    <div class="mt-4 me-md-0">
                        <img src="{{ URL::asset('images/crypto/features-img/img-2.png') }}" alt=""
                            class="img-fluid mx-auto d-block">
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-xl-4 col-sm-6">
                    <div class="blog-box mb-4 mb-xl-0">
                        <div class="position-relative">
                            <img src="{{ URL::asset('images/crypto/blog/img-1.jpg') }}" alt=""
                ...
                <div class="col-xl-4 col-sm-6">
                    <div class="blog-box mb-4 mb-xl-0">
                        ...
                        <div class="position-relative">
                            <img src="{{ URL::asset('images/crypto/blog/img-2.jpg') }}" alt=""
                                class="rounded img-fluid mx-auto d-block">
                            <div class="badge bg-success blog-badge font-size-11">Cryptocurrency</div>
                        </div>
                ...
                <div class="col-xl-4 col-sm-6">
                    <div class="blog-box mb-4 mb-xl-0">
                        <div class="position-relative">
                            <img src="{{ URL::asset('images/crypto/blog/img-3.jpg') }}" alt=""
                                class="rounded img-fluid mx-auto d-block">
                            <div class="badge bg-success blog-badge font-size-11">Cryptocurrency</div>
                        </div>
