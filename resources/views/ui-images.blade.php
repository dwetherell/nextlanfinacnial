    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <img class="rounded me-2" alt="200x200" width="200" src="{{ URL::asset('images/small/img-4.jpg') }}" data-holder-rendered="true">
                    </div>
                    <div class="col-md-6">
                        <div class="mt-4 mt-md-0">
                            <img class="rounded-circle avatar-xl" alt="200x200" src="{{ URL::asset('images/users/avatar-4.jpg') }}" data-holder-rendered="true">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mt-4 mt-md-0">
                            <img class="img-thumbnail rounded-circle avatar-xl" alt="200x200" src="{{ URL::asset('images/users/avatar-3.jpg') }}" data-holder-rendered="true">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="row">
                            <div class="col-lg-4">
                                <div>
                                    <img src="{{ URL::asset('images/users/avatar-3.jpg') }}" alt="" class="rounded avatar-sm">
                                    <p class="mt-2 mb-lg-0"><code>.avatar-sm</code></p>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div>
                                    <img src="{{ URL::asset('images/users/avatar-4.jpg') }}" alt="" class="rounded avatar-md">
                                    <p class="mt-2  mb-lg-0"><code>.avatar-md</code></p>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div>
                                    <img src="{{ URL::asset('images/users/avatar-5.jpg') }}" alt="" class="rounded avatar-lg">
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            <div class="col-lg-4">
                                <div>
                                    <img src="{{ URL::asset('images/users/avatar-3.jpg') }}" alt="" class="rounded-circle avatar-sm">
                                    <p class="mt-2 mb-lg-0"><code>.avatar-sm</code></p>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div>
                                    <img src="{{ URL::asset('images/users/avatar-4.jpg') }}" alt="" class="rounded-circle avatar-md">
                                    <p class="mt-2  mb-lg-0"><code>.avatar-md</code></p>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div>
                                    <img src="{{ URL::asset('images/users/avatar-5.jpg') }}" alt="" class="rounded-circle avatar-lg">
                                    <p class="mt-2 mb-lg-0"><code>.avatar-lg</code></p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="card-body">
                ...
                <div class="d-flex">
                    <div class="flex-shrink-0 me-3">
                        <img class="rounded avatar-sm" src="{{ URL::asset('images/users/avatar-3.jpg') }}" alt="Generic placeholder image">
                    </div>
                ...
                <div class="d-flex align-items-center">
                    <div class="flex-shrink-0 me-3">
                        <img class="rounded avatar-sm" src="{{ URL::asset('images/users/avatar-5.jpg') }}" alt="Generic placeholder image">
                    </div>
                    <div class="flex-grow-1">
                ...
                <div class="d-flex align-items-end">
                    <div class="flex-shrink-0 me-3">
                        <img class="rounded avatar-sm" src="{{ URL::asset('images/users/avatar-1.jpg') }}" alt="Generic placeholder image">
                    </div>
                    <div class="flex-grow-1">
