    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-sm-6">
            <div class="card text-center">
                <div class="card-body">
                    <div class="mb-4">
                        <img class="rounded-circle avatar-sm" src="{{ URL::asset('images/users/avatar-2.jpg') }}" alt="">
                    </div>
        ...
        <div class="col-xl-3 col-sm-6">
            <div class="card text-center">
                <div class="card-body">
                    <div class="mb-4">
                        <img class="rounded-circle avatar-sm" src="{{ URL::asset('images/users/avatar-3.jpg') }}" alt="">
                    </div>
    ...
    <div class="row">
        <div class="col-xl-3 col-sm-6">
            <div class="card text-center">
                <div class="card-body">
                    <div class="mb-4">
                        <img class="rounded-circle avatar-sm" src="{{ URL::asset('images/users/avatar-4.jpg') }}" alt="">
                    </div>
        ...
        <div class="col-xl-3 col-sm-6">
            <div class="card text-center">
                <div class="card-body">
                    <div class="mb-4">
                        <img class="rounded-circle avatar-sm" src="{{ URL::asset('images/users/avatar-5.jpg') }}" alt="">
                    </div>
        ...
        <div class="col-xl-3 col-sm-6">
            <div class="card text-center">
                <div class="card-body">
                    <div class="mb-4">
                        <img class="rounded-circle avatar-sm" src="{{ URL::asset('images/users/avatar-7.jpg') }}" alt="">
                    </div>
